                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  height: 150,
                                  width: 400,
                                  child: Image(image: AssetImage("assets/images/doctor3.png"),),
                                )
                              ],
                            ),
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    Text("30.50",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16),),
                                                  ],
                                                ),
                                                Row(
                                                  children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("Prof. Dr. Kevin Williams",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25),),
                      SizedBox(height: 5,),
